...
## Requirements
The provided Kibana dashboards require a minimum version of 7.8.0. If you are using the provided [docker-compose.yaml](docker-compose.yaml) file, this version requirement is met.
